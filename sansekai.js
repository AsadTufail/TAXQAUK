            ...
            if (budy) {
                try {
                    ...
                    if(budy.toLowerCase() == 'hello') {
                        ...
                        await m.reply(`For the most accurate and relevant answers, please provide as much context as possible when asking your question. If you would like assistance on a specific topic, simply type in the corresponding keyword. For example, type in /Tax and Accounting for examples on how I can assist on the subject of UK Tax and Accounting.\n\n*Topic options:*\n• UK Tax and Accounting - */Tax and Accounting*\n• UK Law - */Law*\n• UK Human Resources (HR) - */HR*\n• Information Technology (IT) - */IT*\n• Marketing and Advertising - */Marketing*\n• Business Strategy - */Business Strategy*\n\nAlternatively, if you have a specific business question, feel free to ask, and I'll do my best to provide helpful insights.`) 
                        ...
                        const response = await openai.createCompletion({
                            model: "gpt-3.5-turbo", //text-davinci-003 //gpt-3.5-turbo //gpt-3.5-turbo-0613
